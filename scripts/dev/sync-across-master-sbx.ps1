...
<#
.SYNOPSIS
    Synchronize work across sandboxes and master, behind a typed gate.
...
.EXAMPLE
    ./scripts/dev/sync-across-master-sbx.ps1 -WhatIf
...
Start-RunLog -Name "sync-across-master-sbx" | Out-Null
