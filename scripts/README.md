...
| `user/sandbox/Merge-Sandbox.cmd` | Same gates as promotion, but keeps the sandbox: validate, push, open the PR, merge into `master`, verify it landed, then resynchronize the sandbox so work continues in the same lane |
