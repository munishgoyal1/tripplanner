...
param apexManagedCertificateName = 'tripplanner-prod-apex-target'
param wwwCustomDomain = 'www.aitripplanner.co'
param wwwManagedCertificateName = 'tripplanner-prod-www-target'
...
param cosmosDatabaseName = readEnvironmentVariable('COSMOS_DATABASE', 'tripplanner-prod')
param minReplicas = 0
param maxReplicas = 1
param enableFailureAlerts = true
param failureAlertEmail = 'munishgoyal@aitripplanner.co'
