...
| PUBLIC-01 | Public custom-domain MVP with traction feedback loop | Partially implemented; permanent `/welcome` landing route and privacy-safe analytics implemented |
