...
| --- | --- | --- | --- |
| Agent 1 - SmallFixes | `C:\repos\tripplanner.worktrees\worker-1` | `agents/worker-1` | `tripplanner-worker-1.code-workspace` |
...
Agent 1 defaults to small, focused fixes across the product.
