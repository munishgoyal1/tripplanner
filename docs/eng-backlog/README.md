...
| [Evaluation and planning efficiency](evaluation-and-planning-efficiency.md) | Corpus probes on every pull request (EE-05); EE-01 to EE-04 are in `implemented/` | Deferred |
