...
| `src/tripplanner/ops_metrics.py` | Content-free rolling API/model metrics for the hidden owner operations dashboard |
...
| `frontend/src/ops/OpsDashboard.tsx` | Direct-only owner operations screen; server authorization remains authoritative |
