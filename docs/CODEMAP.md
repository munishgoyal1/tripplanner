...
| `scripts/dev/build_corpus.py`, `scripts/dev/build-corpus.ps1` | Budgeted paid corpus generation; selects `global`, `india-domestic`, or `india-outbound` with dry-run support and a legacy `--country india` alias |
