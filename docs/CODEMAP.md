...
| `infra/migration/` | Manifest-driven, resumable Azure and Google account migration; inventory, parallel target provisioning, exact eight-container Cosmos transfer, billing guardrails, cutover, evidence checkpoints, and allowlisted source retirement remain separately approved phases |
