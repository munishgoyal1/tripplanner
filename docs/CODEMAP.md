...
| `infra/migration/google/` | Staged Google account migration: source-billing project discovery, access handoff, in-place organization and billing moves, guardrail recreation, verification checkpoints, and old-principal retirement |
