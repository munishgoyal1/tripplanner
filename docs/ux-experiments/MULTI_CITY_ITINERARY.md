...
Implement **A - Transition spine**. Keep checkout, the complete journey,
destination check-in, and remaining plans in one chronological chain without
paired hotel cards or separate city chapters. Keep the itinerary fixed to the
decisions already made, and defer broader controls for comparing or replacing
transport modes, attractions, and other choices to a separate interaction design.
...
- Supersedes: B - Stay handoff implementation from 2026-08-02
