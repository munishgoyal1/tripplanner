...
def registry() -> tuple[Rule, ...]:
    ...
    from tripplanner.evals.deterministic.mutations import METAMORPHIC_RULES
    from tripplanner.evals.deterministic.render import RENDER_RULES
    from tripplanner.evals.human import rules as quality_rules
