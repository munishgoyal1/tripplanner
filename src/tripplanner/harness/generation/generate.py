...
from tripplanner.harness import budget as budget_module
from tripplanner.harness.generation import matrix as matrix_module
from tripplanner.harness.generation.catalog import Catalog
from tripplanner.harness.generation.matrix import TripRequest
from tripplanner.harness.sources.emulator import assert_generation_database, read_generation_trips
...
def _usage_for(database: str, user_id: str) -> dict[str, Any]:
    ...
    from tripplanner.harness.sources.emulator import _client
