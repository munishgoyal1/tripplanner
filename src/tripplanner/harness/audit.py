...
from tripplanner.evals.findings import Finding, Group, group
from tripplanner.harness import corpus as corpus_module
from tripplanner.harness.baseline import load_baseline, new_groups
from tripplanner.harness.corpus import CorpusRecord
...
def collect(
    ...
    *,
    ...
    from tripplanner.harness.sources.emulator import (
    ...
    if generated_finals:
        from tripplanner.harness.sources import place_cache as place_cache
...
def audit(
    ...
    **collect_kwargs: Any,
    ...
    from tripplanner.evals.human import gate_findings
    from tripplanner.evals.human import load as load_quality_ratings
