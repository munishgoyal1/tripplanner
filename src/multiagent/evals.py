...
from multiagent.hallucination_critic import critique as critique_grounding
from multiagent.tools.finalize_critic import critique as critique_finalize
...
def main(argv: list[str] | None = None) -> int:
    ...
    Examples:
        python -m multiagent.evals --list
        python -m multiagent.evals family_dubai_accessible plan.json
    """
