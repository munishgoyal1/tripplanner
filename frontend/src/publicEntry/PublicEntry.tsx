...
function InlineChoice({
  ...
  if (overruled) {
    return (
      <li className="rounded-xl bg-sand px-3 py-2.5 ring-1 ring-amber-400/30">
        <p className={`text-[11px] font-semibold ${dark.heading}`}>{decision.outcome.headline}</p>
        <p className="mt-0.5 flex items-start gap-1.5 text-[11px] leading-relaxed text-amber-800">
      ...
      <div className="relative overflow-hidden bg-[#080b11]">
        ...
        <section className="relative px-6 pb-8 pt-10">
          <div className="flex flex-wrap items-center gap-2">
            <span className="inline-flex items-center gap-1.5 rounded-full bg-emerald-400/15 px-2.5 py-1 text-[11px] font-bold uppercase text-sage ring-1 ring-emerald-400/30">
          ...
          <h1 className={`display mt-3 max-w-3xl text-4xl font-normal leading-tight sm:text-5xl ${dark.heading}`}>
          ...
          <div className="mt-6 grid gap-3 lg:grid-cols-[0.95fr_1.05fr]">
            ...
            <div className="space-y-3">
              ...
              {active ? (
                <div className="rounded-xl bg-sand px-3.5 py-2.5 ring-1 ring-amber-400/30">
                  <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
                    <span className="text-[11px] font-bold uppercase text-amber-800">Re-settled around your change</span>
