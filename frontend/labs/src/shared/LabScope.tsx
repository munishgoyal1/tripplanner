...
const scopes: Record<string, ScopeDefinition> = {
  "itinerary-pane-polish": {
    changes: [
      ...
      "Options A and C only: small workspace-wide finish changes — neutral tokens, pane header styling, pane radius and shadow, day bar dots and selection, notification strip, toolbar and Details chip styling — with no change to layout, pane order or controls",
    ],
    context: [
