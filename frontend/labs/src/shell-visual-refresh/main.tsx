  ...
  return (
    <main className="min-h-full bg-[#f4f6f5] px-4 py-7 sm:px-6 lg:px-8" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      <div className="mx-auto max-w-[92rem]">
        ...
        <section data-lab-change="Workspace visual language and pane controls" className="mt-2 h-[760px] max-h-[78vh] min-h-[620px] overflow-hidden rounded-md border border-[#dce2df] bg-white shadow-sm" aria-label="Interactive workspace refresh preview"><Workspace variant={variant} /></section>
